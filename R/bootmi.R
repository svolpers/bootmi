...
##' @rdname bootmi
##' @export
##' @return a class of type bootmi containing original and bootstrap
##' samples using deterministic imputation as proposed by 
##' Shao and Sitter (1996) 
##' @param formula regression formula
##' @param data original imputed data set
##' @param R total amount of bootstrap samples
##' @param impute imputation method used
##' @param center_mods information if moderators are centered
##' @param seed seed value used, default FALSE
##' @param parallel if object was calculated using parallel package, 
##' default FALSE
##' @param resint seed value used, default FALSE
##' @method bootmi default
##' @export
